            ...
            switch (choice) {
                ...
                case 5: // 存款
                    ...
                    try {
                        ...
                        System.out.println("存款成功，帳戶 " + depAccount.getAccountNumber() + " 現在餘額: " + depAccount.getBalance());
                ...
                case 6: // 提款
                    ...
                    String wdAccNum = scanner.nextLine();
                    Account wdAccount = customerInAction(customers, wdAccNum);
                    if (wdAccount == null) break;
                    System.out.print("輸入提款金額: ");
                    double wdAmount = scanner.nextDouble();
                    scanner.nextLine();
                    try {
                        wdAccount.withdraw(wdAmount);
                        System.out.println("提款成功，帳戶 " + wdAccount.getAccountNumber() + " 現在餘額: " + wdAccount.getBalance());
                    } catch (IllegalArgumentException e) {
